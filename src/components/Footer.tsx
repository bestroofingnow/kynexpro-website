    ...
    <footer className="bg-secondary text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="font-bold text-xl">Kynex<span className="text-accent">Pro</span></span>
            </div>
            <p className="text-gray-300 mb-4 max-w-md">
              Your Premier AI Integration Partner. We provide seamless AI solutions that enhance customer engagement and streamline operations for home service businesses.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/apps" className="text-gray-300 hover:text-accent transition-colors">Our Apps</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li className="flex items-start space-x-2">
                ...
                <span>2217 Matthews Township PKWY<br />D-233, Matthews, NC 28105</span>
              </li>
              <li className="flex items-center space-x-2">
                <svg className="w-5 h-5 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <a href="mailto:kynexpro@gmail.com" className="hover:text-accent transition-colors">kynexpro@gmail.com</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} Kynex Pro. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
